...
from app.api.api_v1.endpoints import auth, course, student, verify, recommendation
...
api_router.include_router(recommendation.router, prefix="/rec", tags=["recommendation"])
